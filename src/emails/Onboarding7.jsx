    ...
    <Marketing preview={props.preview}>
      <Container>
        <Card>
          ...
          <H1>You estimate it, your clients will too 💪</H1>
        </Card>
        ...
        <Card style={{ textAlign: 'left' }}>
          ...
          <P>
            ...
            clear project overview, they can&apos;t grasp the value behind each stage. But now, it&apos;s
            simple. Build projects in Flowmapp and enhance them with detailed, transparent
            estimates.
          </P>
          <P>
