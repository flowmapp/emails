    ...
    <Marketing preview={props.preview}>
      <Container>
        ...
        <Card style={{ textAlign: 'left' }}>
          <H2>
            Wireframes work wonders for website sales because they show your clients that you&apos;ve
            already completed 50% of the work.
          </H2>
          <br />
          ...
          <div>
            ...
            <div style={s.blackBlock}>
              ...
              <H3 style={s.blackBlockText}>High cost of development</H3>
            </div>
            <div style={{ ...s.blackBlock, marginRight: 0 }}>
              <H1 style={s.blackBlockHeader}>03</H1>
              <H3 style={s.blackBlockText}>Time-consuming process</H3>
            </div>
          </div>
